...
ActiveRecord::Schema.define(version: 20151007165826) do
  ...
  add_index "user_postings", ["post_id"], name: "index_user_postings_on_post_id", using: :btree
  add_index "user_postings", ["user_id"], name: "index_user_postings_on_user_id", using: :btree
